...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///Users/bharath/Documents/expert-resumes/node_modules/h3/dist/index.mjs';
import express from 'file:///Users/bharath/Documents/expert-resumes/node_modules/express/index.js';
import mongoose from 'file:///Users/bharath/Documents/expert-resumes/node_modules/mongoose/index.js';
import cors from 'file:///Users/bharath/Documents/expert-resumes/node_modules/cors/lib/index.js';
import pdfMake from 'file:///Users/bharath/Documents/expert-resumes/node_modules/pdfmake/build/pdfmake.js';
import pdfFonts from 'file:///Users/bharath/Documents/expert-resumes/node_modules/pdfmake/build/vfs_fonts.js';
import dotenv from 'file:///Users/bharath/Documents/expert-resumes/node_modules/dotenv/lib/main.js';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/bharath/Documents/expert-resumes/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/bharath/Documents/expert-resumes/node_modules/devalue/index.js';
import destr from 'file:///Users/bharath/Documents/expert-resumes/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/bharath/Documents/expert-resumes/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/bharath/Documents/expert-resumes/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Users/bharath/Documents/expert-resumes/node_modules/ohash/dist/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Users/bharath/Documents/expert-resumes/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/bharath/Documents/expert-resumes/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/bharath/Documents/expert-resumes/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/bharath/Documents/expert-resumes/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/bharath/Documents/expert-resumes/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/bharath/Documents/expert-resumes/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/bharath/Documents/expert-resumes/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///Users/bharath/Documents/expert-resumes/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/bharath/Documents/expert-resumes/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/bharath/Documents/expert-resumes/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/bharath/Documents/expert-resumes/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///Users/bharath/Documents/expert-resumes/node_modules/unctx/dist/index.mjs';
import { isVNode, version, unref } from 'file:///Users/bharath/Documents/expert-resumes/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///Users/bharath/Documents/expert-resumes/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/bharath/Documents/expert-resumes/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "apiBase": "",
    "mongodbUri": "mongodb+srv://expertresumes:Expert121%40@expertresumes.4hygjkm.mongodb.net/",
    "public": {
      "apiBase": "/api"
    },
    "gtag": {
...
const serverAssets = [{"baseName":"server","dir":"/Users/bharath/Documents/expert-resumes/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/bharath/Documents/expert-resumes","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/bharath/Documents/expert-resumes/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/bharath/Documents/expert-resumes/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/bharath/Documents/expert-resumes/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/bharath/Documents/expert-resumes/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _yx0sbLThIv = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/bharath/Documents/expert-resumes";
...
const _lazy_tK1gen = () => Promise.resolve().then(function () { return index; });
const _lazy_p1ZfnP = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api', handler: _lazy_tK1gen, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_p1ZfnP, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_p1ZfnP, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///Users/bharath/Documents/expert-resumes/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/bharath/Documents/expert-resumes/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
